...
public class Category implements AppenderAttachable {
     ...
     *
     * <p>This method calls all the appenders inherited from the hierarchy circumventing any evaluation
    ...
    public void debug(Object message, Throwable t) {
        if (repository.isDisabled(Level.DEBUG_INT)) return;
        if (Level.DEBUG.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.DEBUG, message, t);
    }
    ...
    public void error(Object message) {
        ...
        if (Level.ERROR.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.ERROR, message, null);
    }
    ...
    public void error(Object message, Throwable t) {
        if (repository.isDisabled(Level.ERROR_INT)) return;
        if (Level.ERROR.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.ERROR, message, t);
    ...
    public void fatal(Object message) {
        ...
        if (Level.FATAL.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.FATAL, message, null);
    }
    ...
    public void fatal(Object message, Throwable t) {
        if (repository.isDisabled(Level.FATAL_INT)) return;
        if (Level.FATAL.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.FATAL, message, t);
    }


    /**
     * This method creates a new logging event and logs the event without further checks.
     * 此方法创建一个新的日志事件，并在不进行进一步检查的情况下记录该事件。
     */
    ...
    public Level getEffectiveLevel() {
        ...
        // 如果运行到这将会有 NullPointerException 异常.
        return null;
    }
     ...
     * 使用info级别记录日志信息
     *
     * <p>This method first checks if this category is <code>INFO</code> enabled
     * by comparing the level of this category with {@link Level#INFO INFO} Level.
     * 这个方法首先通过比较category类别的级别和info Level,来检查这个category类别是否启用info.
     * <p>
     * If the category is <code>INFO</code>
     * enabled, then it converts the message object passed as parameter
     * to a string by invoking the appropriate
     * {@link org.apache.log4j.or.ObjectRenderer}. It
     * proceeds to call all the registered appenders in this category and
    ...
    public void info(Object message, Throwable t) {
        ...
        if (Level.INFO.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.INFO, message, t);
    }
    ...
    public void log(Priority priority, Object message, Throwable t) {
        ...
        if (priority.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, priority, message, t);
    }
    ...
    public void log(Priority priority, Object message) {
        ...
        if (priority.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, priority, message, null);
    }
    ...
    public void warn(Object message) {
        ...
        if (Level.WARN.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.WARN, message, null);
    }
    ...
    public void warn(Object message, Throwable t) {
        if (repository.isDisabled(Level.WARN_INT)) return;
        if (Level.WARN.isGreaterOrEqual(this.getEffectiveLevel())) forcedLog(FQCN, Level.WARN, message, t);
    }
}
