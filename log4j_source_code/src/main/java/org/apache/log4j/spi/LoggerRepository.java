...
public interface LoggerRepository {
    ...
    /**
     * Returns whether this repository is disabled for a givenlevel.
     * 返回该存储库是否禁用给定级别。
     *
     * The answer depends on the repository threshold and the <code>level</code> parameter.
     * 答案取决于存储库threshold阈值和<code>level级别</code>参数。
     *
