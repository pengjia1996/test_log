 ...
 *
 * <p>The goal of this class is to {@link #format format} a {@link LoggingEvent} and return the results as a String.
 ...
 *
 * <em>conversion specifiers 转换说明符</em>.
 *
 * <p>
 * <i>
 ...
 *
 * <td>Used to output the category of the logging event.
 * 用于输出日志事件的类别。
 *
 * The category conversion specifier can be optionally followed by <em>precision specifier</em>,
 * 类别转换说明符后面可选地跟着<em>精度说明符</em>，
 * that is a decimal constant in brackets.
 * 精度这指的是括号中的十进制常数。
 *
 * <p>If a precision specifier is given,
 * then only the corresponding number of right most components of the category name will be printed.
