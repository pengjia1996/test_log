...
public class Level extends Priority implements Serializable {
     ...
     *  INFO级别 指在粗粒度级别突出显示应用程序进度的信息性消息。
     */
    ...
    public static Level toLevel(String sArg, Level defaultLevel) {
        if (sArg == null) return defaultLevel;
